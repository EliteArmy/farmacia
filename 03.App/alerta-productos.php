<?php $idPagina = "registro-lote-producto";
...
<body>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="ModalLabel">Modificar Descuento</h5>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="form-group col-12 col-sm-6 col-md-6">
              ...
              <input id="nombre-lote" type="text" class="form-control" disabled="disabled" placeholder="Nombre del Lote">
            </div>

            <div class="form-group col-12 col-sm-6 col-md-6">
            <label for="slc-prod">Producto</label>
              <select disabled="disabled" id="slc-prod" class="selectpicker form-control" data-live-search="true" title="Productos" data-style="btn-primary">
                <!--Informacion generada -->
              </select>
            </div>
            ...
            <div class="form-group col-12 col-sm-6 col-md-6">
              ...
              <input id="precio-compra" class="form-control" disabled="disabled" type="text" placeholder="0.00">
            </div>

            <div class="form-group col-12 col-sm-6 col-md-6">
              <label for="precio-venta">Precio de Venta</label><br>
              <input id="precio-venta" class="form-control" disabled="disabled" type="text" placeholder="0.00">
            </div>

            <div class="form-group col-12 col-sm-6 col-md-6">
              <label for="fecha-elab">Fecha de Elaboración</label><br>
              <input id="fecha-elab" class="form-control" disabled="disabled" type="date" placeholder="2000-12-31">
            </div>

            <div class="form-group col-12 col-sm-6 col-md-6">
              <label for="fecha-venc">Fecha de Vencimiento</label><br>
              <input id="fecha-venc" class="form-control" disabled="disabled" type="date" placeholder="2000-12-31">
            </div>

            <div class="form-group col-12 col-sm-6 col-md-6">
              <label for="cantidad">Cantidad</label><br>
              <input id="cantidad" class="form-control" disabled="disabled" type="number" step="1" min="0" placeholder="0">
            </div>
  ...
  <script type="text/javascript" src="./js/controlador/alerta-productos.js"></script>
